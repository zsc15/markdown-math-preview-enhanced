...
type VSCodeMPEConfigKey =
  ...
  | 'enableMathJaxEquationNumbering'
  | 'previewColorScheme'
  | 'previewMode'
  | 'qiniuAccessKey'
  | 'qiniuBucket'
...
export class MarkdownPreviewEnhancedConfig implements NotebookConfig {
  ...
  public readonly enableMathJaxEquationNumbering: boolean;
  ...
  private constructor() {
    ...
    this.enableMathJaxEquationNumbering =
      getMPEConfig<boolean>('enableMathJaxEquationNumbering') ?? false;
