...
class NotebooksManager {
  ...
  private async loadNotebookConfig(
    ...
    const mergedConfig: Partial<MarkdownPreviewEnhancedConfig> = {
      ...vscodeMPEConfig,
      ...globalConfig,
      ...workspaceConfig,
      globalCss:
    ...
    if (vscodeMPEConfig.enableMathJaxEquationNumbering) {
      const baseMathjaxConfig = mergedConfig.mathjaxConfig ?? {};
      const texConfig = (baseMathjaxConfig as any).tex ?? {};
      mergedConfig.mathjaxConfig = {
        ...baseMathjaxConfig,
        tex: {
          ...texConfig,
          tags: 'all',
      ...
      mergedConfig.mathRenderingOption = 'MathJax';
    }
